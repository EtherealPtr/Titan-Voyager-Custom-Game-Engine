...
void Game::InitMeshes()
{
	...
	m_model[0].Init("res/Models3D/Aircraft/Aircraft.obj", &m_camera, aShader.GetShaderProgram());
	m_model[1].Init("res/Models3D/Rock/rock.obj", &m_camera, aShader.GetShaderProgram());
}
