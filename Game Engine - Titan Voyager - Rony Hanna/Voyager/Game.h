...
private:
	...
	enum { SATURN_RINGS = 1, SPACE_CUBE, SKYBOX, SATURN, FPS_CROSSHAIR, AMMO, HEALTH, MUZZLE_FLASH, SNIPER_SCOPE, POSTPROCESSING_QUAD, ENEMY_DRONE, ENEMY_BLAST, MAIN_MENU, INDICATOR, HIT_MARKER };
